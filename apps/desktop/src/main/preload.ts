...
contextBridge.exposeInMainWorld("dexNest", {
  ...
  devIntelligenceStatus: () => ipcRenderer.invoke("dexnest:dev-intelligence-status"),
  devIntelligenceSettings: () => ipcRenderer.invoke("dexnest:dev-intelligence-settings"),
  ...
  autopilotMorningBrief: (options?: { sinceHours?: number }) => ipcRenderer.invoke("dexnest:autopilot-morning-brief", options),
