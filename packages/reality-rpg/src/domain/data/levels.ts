/**
 * The level curve - data only. Entry i is the total XP needed to reach level
 * i + 1. Level n needs 50 * n * (n - 1) XP: 0, 100, 300, 600, 1000, ...
 * Edit freely; the tests check it starts at 0 and strictly increases.
 */
