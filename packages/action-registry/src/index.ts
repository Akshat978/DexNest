...
export const seededActions = [
  ...
  // Deck-exposed: its evidence names local repositories and paths.
  {
    ...
    moduleId: "skill_constellation",
    module: "skill_constellation",
    description: "Open the Skill Constellation view: your skills, each with the repositories, files and dates that support it.",
    category: "navigation",
    dangerLevel: "safe",
    requiresConfirmation: false,
    confirmationRule: null,
  ...
  {
    id: "skill_constellation.rebuild",
    title: "Rebuild Skill Constellation",
    moduleId: "skill_constellation",
    module: "skill_constellation",
    description: "Rebuild the constellation now from what Developer Intelligence has recorded. Skipped when nothing has changed.",
    category: "diagnostics",
    dangerLevel: "safe",
    requiresConfirmation: false,
    confirmationRule: null,
    ...
    undoActionId: null,
    handlerType: "internal_function",
    handlerRef: "skill_constellation.rebuild",
    allowedTriggers: ["command", "module_ui"],
    enabled: true,
    status: "available"
  },
  {
    id: "skill_constellation.enable",
    title: "Turn On Skill Constellation",
    moduleId: "skill_constellation",
    module: "skill_constellation",
    description: "Turn on Skill Constellation so it rebuilds on a schedule after Developer Intelligence records something new.",
    category: "settings",
    dangerLevel: "safe",
    requiresConfirmation: false,
    confirmationRule: null,
    ...
    undoActionId: null,
    handlerType: "internal_function",
    handlerRef: "skill_constellation.enable",
    allowedTriggers: ["command", "module_ui"],
    enabled: true,
    status: "available"
  },
  {
    id: "skill_constellation.disable",
    title: "Turn Off Skill Constellation",
    moduleId: "skill_constellation",
    module: "skill_constellation",
    description: "Turn off Skill Constellation's scheduled rebuilds. The current constellation is kept.",
    category: "settings",
    dangerLevel: "safe",
    requiresConfirmation: false,
    confirmationRule: null,
    ...
    undoActionId: null,
    handlerType: "internal_function",
    handlerRef: "skill_constellation.disable",
    allowedTriggers: ["command", "module_ui"],
    enabled: true,
    status: "available"
  },
